import{a as m,S as O,N as j,K as _}from"./assets/vendor-CIDwANU8.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))o(e);new MutationObserver(e=>{for(const r of e)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&o(n)}).observe(document,{childList:!0,subtree:!0});function a(e){const r={};return e.integrity&&(r.integrity=e.integrity),e.referrerPolicy&&(r.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?r.credentials="include":e.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function o(e){if(e.ep)return;e.ep=!0;const r=a(e);fetch(e.href,r)}})();const d={mobileMenuOpenBtn:document.querySelector(".mobile-menu-open-btn"),mobileMenuCloseBtn:document.querySelector(".mobile-menu-close-btn"),mobileMenu:document.querySelector(".mobile-menu"),mobileMenuLinks:document.querySelectorAll(".mobile-menu-link")};d.mobileMenuOpenBtn.addEventListener("click",()=>{d.mobileMenu.classList.add("is-open"),document.body.classList.add("modal-open")});d.mobileMenuCloseBtn.addEventListener("click",()=>{d.mobileMenu.classList.remove("is-open"),document.body.classList.remove("modal-open")});d.mobileMenuLinks.forEach(t=>{t.addEventListener("click",()=>{d.mobileMenu.classList.remove("is-open"),document.body.classList.remove("modal-open")})});const i={artistsListContainer:document.querySelector(".artists-list"),loadMoreBtn:document.querySelector(".load-more-btn"),loader:document.querySelector(".loader"),artistDetailsModal:document.querySelector(".js-artist-details-backdrop"),artistDetailsContainer:document.querySelector(".artist-modal-content"),feedbacksContainer:document.querySelector(".swiper-wrapper"),paginationDotFirst:document.querySelector(".dot-first"),paginationDotMiddle:document.querySelector(".dot-middle"),paginationDotLast:document.querySelector(".dot-last"),modalLoader:document.querySelector(".modal-loader-wrapper .loader"),artistModal:document.querySelector(".artist-modal")},f="https://sound-wave.b.goit.study/api",g="/artists/",x="/albums/",F="/feedbacks/";async function K(t,s){const a=f+g,o={limit:t,page:s};return(await m.get(a,{params:o})).data}async function H(){const t=f+F,s={limit:10};return(await m.get(t,{params:s})).data}async function R(t){const s=f+g+t+x,a={};return(await m.get(s,{params:a})).data}const l="/goit-js-project-ArtistsHub/assets/icons-B_PfIQ6b.svg";function b(t){return t.map(s=>`<li class="artist-genres-item">${s}</li>`).join("")}function Y(t){const{_id:s,strArtist:a,strArtistThumb:o,strBiographyEN:e,genres:r}=t,n=b(r);return`<li class="artists-item">
        <img
          src="${o}"
          alt="Artist ${a}"
          class="artist-photo"
      ...
      </li>`}function G(t){const s=t.map(Y).join("");i.artistsListContainer.insertAdjacentHTML("beforeend",s)}function U(){i.loader.classList.remove("is-hidden")}function Q(){i.loader.classList.add("is-hidden")}function V(){i.modalLoader.classList.remove("is-hidden")}function W(){i.modalLoader.classList.add("is-hidden")}function z(t,s){t<s?i.loadMoreBtn.classList.remove("is-hidden"):i.loadMoreBtn.classList.add("is-hidden")}function J(t){const{name:s,descr:a,rating:o}=t;return`<div class="swiper-slide">
...
</div>`}function X(t){const s=t.map(J).join("");i.feedbacksContainer.innerHTML=s}function Z(t){const s=Math.floor(t/1e3),a=Math.floor(s/60),o=s%60,e=o<10?`0${o}`:o;return`${a}:${e}`}function tt(t){const{strArtist:s,strArtistThumb:a,intFormedYear:o,intDiedYear:e,strGender:r,intMembers:n,strCountry:k,strBiographyEN:S,genres:A,albumsList:D}=t,w=b(A),E=D.map(B=>{const{strAlbum:T,tracks:C}=B,q=C.map(I=>{const{intDuration:N,movie:p,strTrack:P}=I;return`<tr class="artist-modal-album-row">
