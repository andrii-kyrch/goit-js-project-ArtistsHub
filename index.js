import{a as m,S as O,N as j,K as x}from"./assets/vendor-CIDwANU8.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))r(e);new MutationObserver(e=>{for(const o of e)if(o.type==="childList")for(const n of o.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&r(n)}).observe(document,{childList:!0,subtree:!0});function a(e){const o={};return e.integrity&&(o.integrity=e.integrity),e.referrerPolicy&&(o.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?o.credentials="include":e.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(e){if(e.ep)return;e.ep=!0;const o=a(e);fetch(e.href,o)}})();const d={mobileMenuOpenBtn:document.querySelector(".mobile-menu-open-btn"),mobileMenuCloseBtn:document.querySelector(".mobile-menu-close-btn"),mobileMenu:document.querySelector(".mobile-menu"),mobileMenuLinks:document.querySelectorAll(".mobile-menu-link")};d.mobileMenuOpenBtn.addEventListener("click",()=>{d.mobileMenu.classList.add("is-open"),document.body.classList.add("modal-open")});d.mobileMenuCloseBtn.addEventListener("click",()=>{d.mobileMenu.classList.remove("is-open"),document.body.classList.remove("modal-open")});d.mobileMenuLinks.forEach(t=>{t.addEventListener("click",()=>{d.mobileMenu.classList.remove("is-open"),document.body.classList.remove("modal-open")})});const i={artistsListContainer:document.querySelector(".artists-list"),loadMoreBtn:document.querySelector(".load-more-btn"),loader:document.querySelector(".loader"),artistDetailsModal:document.querySelector(".js-artist-details-backdrop"),artistDetailsContainer:document.querySelector(".artist-modal-content"),feedbacksContainer:document.querySelector(".swiper-wrapper"),paginationDotFirst:document.querySelector(".dot-first"),paginationDotMiddle:document.querySelector(".dot-middle"),paginationDotLast:document.querySelector(".dot-last"),modalLoader:document.querySelector(".modal-loader-wrapper .loader"),artistModal:document.querySelector(".artist-modal")},f="https://sound-wave.b.goit.study/api",g="/artists/",F="/albums/",_="/feedbacks/";async function H(t,s){const a=f+g,r={limit:t,page:s};return(await m.get(a,{params:r})).data}async function K(){const t=f+_,s={limit:10};return(await m.get(t,{params:s})).data}async function R(t){const s=f+g+t+F,a={};return(await m.get(s,{params:a})).data}const l="/goit-js-project-ArtistsHub/assets/icons-CHuY687n.svg";function b(t){return t.map(s=>`<li class="artist-genres-item">${s}</li>`).join("")}function Y(t){const{_id:s,strArtist:a,strArtistThumb:r,strBiographyEN:e,genres:o}=t,n=b(o);return`<li class="artists-item">
        <img
          src="${r}"
          alt="Artist ${a}"
          class="artist-photo"
...
</div>`}function X(t){const s=t.map(Q).join("");i.feedbacksContainer.innerHTML=s}function Z(t){const s=Math.floor(t/1e3),a=Math.floor(s/60),r=s%60,e=r<10?`0${r}`:r;return`${a}:${e}`}function tt(t){const{strArtist:s,strArtistThumb:a,intFormedYear:r,intDiedYear:e,strGender:o,intMembers:n,strCountry:k,strBiographyEN:S,genres:A,albumsList:D}=t,w=b(A),E=D.map(T=>{const{strAlbum:B,tracks:C}=T,q=C.map(I=>{const{intDuration:N,movie:p,strTrack:P}=I;return`<tr class="artist-modal-album-row">
    ...
    <div class="artist-modal-info-block">
      <div class="artist-modal-info-list">
        <dl class="artist-modal-info-item">
          ...
          <dd class="artist-modal-info-value">${r||"information missing"}–${e||"present"}</dd>
        </dl>
        <dl class="artist-modal-info-item">
  ...
  <ul class="artist-modal-album-cards">${E}</ul>`}function st(t){const s=tt(t);i.artistDetailsContainer.innerHTML=s}const v=8;let c=1;async function y(){U();try{const{artists:t,totalArtists:s}=await H(v,c),a=Math.ceil(s/v);G(t),J(c,a)}catch(t){console.log(t)}V(),c>1&&et()}y();i.loadMoreBtn.addEventListener("click",async()=>{c++,await y()});function et(){const s=i.artistsListContainer.firstElementChild.getBoundingClientRect().height;scrollBy({behavior:"smooth",top:s/2})}function L(t){const s=t.target.closest(".modal-close-btn"),a=t.target===i.artistDetailsModal;!s&&!a||$()}function M(t){t.key==="Escape"&&$()}function $(){i.artistDetailsModal.classList.remove("is-open"),i.artistModal.classList.add("is-hidden"),document.body.classList.remove("modal-open"),i.artistDetailsModal.removeEventListener("click",L),document.removeEventListener("keydown",M)}i.artistsListContainer.addEventListener("click",async t=>{const s=t.target.closest(".artist-btn");if(!s)return;const a=s.dataset.artistId;i.artistDetailsModal.classList.add("is-open"),document.body.classList.add("modal-open"),W();const r=await R(a);st(r),z(),i.artistModal.classList.remove("is-hidden"),i.artistDetailsModal.scrollTop=0,i.artistDetailsModal.addEventListener("click",L),document.addEventListener("keydown",M)});async function at(){const{data:t}=await K();X(t)}at();new O(".swiper",{modules:[j,x],on:{init:h,slideChange:h},keyboard:{enabled:!0},breakpoints:{768:{navigation:{nextEl:".feedback-next-btn",prevEl:".feedback-prev-btn"}}}});function h(t){const s=t.slides.length,a=t.activeIndex,{paginationDotFirst:r,paginationDotMiddle:e,paginationDotLast:o}=i;r.classList.remove("active"),e.classList.remove("active"),o.classList.remove("active"),a===0?u(r):a===s-1?u(o):u(e)}function u(t){t.classList.remove("active"),t.offsetWidth,t.classList.add("active")}
